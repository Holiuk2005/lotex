    ...
    return Column(
      ...
      children: [
                ...
                child: Padding(
                  ...
                  child: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                    stream: auction.sellerId.isEmpty
                        ? null
                        : FirebaseFirestore.instance.collection('users').doc(auction.sellerId).snapshots(),
                    builder: (context, snap) {
                      ...
                      final name = (displayName != null && displayName.isNotEmpty)
                          ? displayName
                          : ((legacyName != null && legacyName.isNotEmpty) ? legacyName : seller);
        ...
        if (needsShipping) ...[
          const SizedBox(height: 12),
          _GradientCta(
            label: LotexI18n.tr(lang, 'arrangeShipping'),
            onTap: () => context.push('/shipping/${auction.id}'),
          ),
        ],
        const SizedBox(height: 18),
        Text(
