...
class _CreateAuctionScreenState extends ConsumerState<CreateAuctionScreen> {
  ...
  void _submit() {
    if (_formKey.currentState!.validate()) {
      ...
      final startPrice = double.parse(_startPriceController.text.replaceAll(',', '.'));
  ...
  Widget build(BuildContext context) {
    ...
    final scrollBottomPadding = actionBarHeight + MediaQuery.viewPaddingOf(context).bottom + 32;

    return Scaffold(
      resizeToAvoidBottomInset: true,
      appBar: LotexAppBar(titleText: LotexI18n.tr(lang, 'createLot'), showDefaultActions: false),
      body: Stack(
        children: [
              ...
              child: Column(
                children: [
                    ...
                    child: Column(
                      children: [
                        Material(
                          ...
                          elevation: 12,
                          shadowColor: LotexUiColors.violet500.withAlpha((0.35 * 255).round()),
                    ...
                    child: Container(
                      ...
                      child: _pickedImage != null
                          ...
                          : Column(
                              ...
                              children: [
                                const Icon(Icons.add_photo_alternate_outlined, size: 48, color: Colors.white70),
                                const SizedBox(height: 8),
                                Text(LotexI18n.tr(lang, 'uploadImage'), style: const TextStyle(color: Colors.white70)),
                              ],
                            ),
                    ),
                  ),
                  ...
                  LotexInput(
                    ...
                    validator: (v) => (v == null || v.isEmpty) ? LotexI18n.tr(lang, 'enterTitle') : null,
                  ),
                  ...
                  LotexInput(
                    ...
                    validator: (v) => (v == null || v.isEmpty) ? LotexI18n.tr(lang, 'enterDescription') : null,
                  ),
                  const SizedBox(height: 16),
                  LotexInput(
                    ...
                    validator: (v) {
                      if (v == null || v.isEmpty) return LotexI18n.tr(lang, 'enterAmount');
                      final parsed = double.tryParse(v.replaceAll(',', '.'));
                      if (parsed == null) return LotexI18n.tr(lang, 'invalidPrice');
                      return null;
                    },
                  ),
                  const SizedBox(height: 16),
                        ...
                        if (_buyoutEnabled) ...[
                          ...
                          LotexInput(
                            ...
                            validator: (v) {
                              ...
                              if (v == null || v.trim().isEmpty) return LotexI18n.tr(lang, 'enterAmount');
                              final parsed = double.tryParse(v.replaceAll(',', '.'));
                              if (parsed == null) return LotexI18n.tr(lang, 'invalidPrice');
                              final startRaw = _startPriceController.text.trim();
                              final startParsed = startRaw.isEmpty
                                  ? null
                                  : double.tryParse(startRaw.replaceAll(',', '.'));
                  ...
                  AppInput(
                    ...
                    validator: (v) => v == null || v.isEmpty ? LotexI18n.tr(lang, 'selectDateRequired') : null,
                  ),
                  const SizedBox(height: 24),
                ],
              ),
